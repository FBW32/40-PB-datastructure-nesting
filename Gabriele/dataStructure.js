...
for (let j of board){
    console.log('task1, 2nd way', j);
}

// or

board.forEach(index => console.log(index));
...
let doggo = {
    ...
    Darwin: "shepherd",
    Pepper: "collie",
    favFood: ["meat", "tuna", "chicken"],

    }


console.log(doggo.favFood[1]); // tuna

printFavFood = function() {
    for (let j of doggo.favFood) {
        console.log(j);
    } 
}
...
recipes.ingredients["ginger"] = "zenzero"
recipes.ingredients.brown_sugar = "zucchero";
...
//       flour: 'farina',
//       ginger: 'zenzero',
//       brown_sugar: 'zucchero'
//     },
//     printIngredients: [Function: printIngredients]
//   }

console.log(recipes.printIngredients())  //  [ 'burro', 'farina', 'zenzero', 'zucchero' ]